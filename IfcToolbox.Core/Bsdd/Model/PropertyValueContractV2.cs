...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PropertyValueContractV2 :  IEquatable<PropertyValueContractV2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyValueContractV2" /> class.
        /// </summary>
        ...
        public PropertyValueContractV2(string namespaceUri = default(string), string code = default(string), string value = default(string), string description = default(string), int? sortNumber = default(int?))
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for PropertyValueContractV2 and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        {
            return this.Equals(input as PropertyValueContractV2);
        }

        /// <summary>
        /// Returns true if PropertyValueContractV2 instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertyValueContractV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertyValueContractV2 input)
        {
            if (input == null)
                return false;
